% Nomenclature:
            ...
            if i==1 %NE
                ...
                S_etaomega1 = ((x_P*y_w  - x_w*y_P)  + (x_w*y_nw   - x_nw*y_w)   + (x_nw*y_n  - x_n*y_nw)  + (x_n*y_P - x_P*y_n))/2;
                S_etaw1     = ((x_P*y_W  - x_W*y_P)  + (x_W*y_nW   - x_nW*y_W)   + (x_nW*y_n  - x_n*y_nW)  + (x_n*y_P - x_P*y_n))/2;
            end