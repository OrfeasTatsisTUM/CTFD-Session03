...
% T_P in A.14
syms bc_control_west bc_control_ns alpha lamda Tinf
...
% Build whole stecil acounting for quadratic lamda like in Helmholtz (A.14)
 ...
 DDT1= ((dTdx_etae1*dy_e_ne - dTdy_etae1*dx_e_ne...
     - bc_control_ns*(dy_P_e - dx_P_e)*alpha/lamda*(T_omega-Tinf) ...
     - bc_control_west*(dy_n_P - dx_n_P)*alpha/lamda*(T_eta1-Tinf)...
     + dTdx_nomega*dy_ne_n - dTdy_nomega*dx_ne_n) /S_etaomega1);
    
  DDT2= ((dTdx_etae2*dy_se_e - dTdy_etae2*dx_se_e...
     - bc_control_ns*(dy_e_P - dx_e_P)*alpha/lamda*(T_omega-Tinf) ...
     - bc_control_west*(dy_P_s - dx_P_s)*alpha/lamda*(T_eta2-Tinf)...
